...
const timerMiliseconds = document.querySelector(".timer__milliseconds")
...
function startTimer()
{
    ...
    cancelId = requestAnimationFrame(updateTimer, 1000 / 60)
}
...
function resetTimer()
{
    ...
    timerMiliseconds.innerHTML = '000'
...
function updateTimer()
{
    ...
    timerMiliseconds.innerHTML = millisText
